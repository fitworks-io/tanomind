...
export function GamesPage() {
  ...
  return <FeedShell topics={sampleTopics} activeCluster="games"><div className="min-h-screen bg-[#070514] font-mono text-white">
    <header className="flex h-16 items-center gap-3 border-b-4 border-[#241b4b] bg-[#100a24] px-4 sm:px-6"><Link to="/c/games" className="grid size-9 place-items-center border-2 border-[#65f6ff] text-[#65f6ff]" aria-label="Back to Games"><ArrowLeft size={18}/></Link><div><h1 className="font-black uppercase tracking-[.14em] text-[#fff36b] [text-shadow:3px_3px_0_#7734e7]">Dot Ecosystem</h1><p className="text-[10px] uppercase tracking-[.2em] text-[#65f6ff]">Level {String(round).padStart(2,"0")} · Eat or be eaten</p></div></header>
    <div className="grid gap-5 p-3 sm:p-5"><section>
