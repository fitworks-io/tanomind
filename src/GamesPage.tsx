...
export function DotEcosystemGame({embedded=false}:{embedded?:boolean}={}) {
  ...
  useEffect(()=>{if(!fullscreen)return;const previous=document.body.style.overflow;document.body.style.overflow="hidden";document.body.classList.add("dot-game-fullscreen");return()=>{document.body.style.overflow=previous;document.body.classList.remove("dot-game-fullscreen")}},[fullscreen]);
  useEffect(()=>{
